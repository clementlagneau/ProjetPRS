...
def main():
    ...
    if len(sys.argv) == 4 and 1000 <= int(sys.argv[1]) <= 9999 :
      port = int(sys.argv[1])
      param = int(sys.argv[2]) #taille fenetre init
      param2 = int(sys.argv[3]) #augmentation fenetre
    else :
    ...
    timeout = 0.03
    rtt = 0.02
    taille_fenetre_init = param
    aug_taille_fenetre = param2
    ...
    print("Debit :",(size/(1000000*temps)),"Mo/s")
